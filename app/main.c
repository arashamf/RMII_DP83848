...
int main(void)
{
  ...
  #if defined RUN_TCP_SERVER
  xTaskCreate((TaskFunction_t )tcp_task, (const char*)"tcp_task", (configSTACK_DEPTH_TYPE)192, (void* )NULL, (UBaseType_t)2,	(TaskHandle_t*)&TCPtask_Handler);
  #if defined DEBUG_MODE
  sprintf (dbg_buf, "free_heap_after_create_tcp_task=%u\r\n", xPortGetFreeHeapSize());
  dbg_putStr (dbg_buf);
  #endif
  #endif
